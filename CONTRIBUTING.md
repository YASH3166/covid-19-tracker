...
2.  Pick any issue you want to work on from the [issues](https://github.com/clubgamma/covid-19-tracker/issues), discuss with maintainer on issue and then start.
...
4.  Clone the project.
    ...
    ```shell
    git clone https://github.com/clubgamma/covid-19-tracker
    ```
